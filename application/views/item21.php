				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/keyboard.png'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">Rainbow Effect Keyboard</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">This keyboard has a soft keys having a rainbow light effect while typing or inputing data to your computer. Grab it now! </p>
						<h4 class="price" style="color: black;">current price: <span>Php 232.00</span></h4>
						<p class="vote" style="color: black;"><strong >98%</strong> of buyers enjoyed this item! <strong>(98 votes)</strong></p>
