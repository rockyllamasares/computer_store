				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/sataserial cable.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">SATA Serial Cable</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">A cable that connects hard disk drive and motherboard to collaborate with each other to perform computer task. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 120.00</span></h4>
