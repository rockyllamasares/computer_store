				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/foxin 18.5 inch HD Monitor.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">FOXIN HD Monitor</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">98 reviews</span>
						</div>
						<p class="product-description" style="color: black;">FOXIN 18.5 inches Monitor, it has a high and suitable resolution for HD and clear viewing on your screen. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 4,678.00</span></h4>
						<p class="vote" style="color: black;"><strong>95%</strong> of buyers enjoyed this item! <strong>(90 votes)</strong></p>
