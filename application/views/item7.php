				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/EATON UPS.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">EATON Uninterruptible Power Supply</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">88 reviews</span>
						</div>
						<p class="product-description" style="color: black;">EATON Uninterruptible Power Supply provides enough current to store or save your activities or unfinished documents once there is a shortage of current happens in your area.</p>
						<h4 class="price" style="color: black;">current price: <span>Php 4,000.00</span></h4>
						<p class="vote" style="color: black;"><strong>97%</strong> of buyers enjoyed this item! <strong>(87 votes)</strong></p>
