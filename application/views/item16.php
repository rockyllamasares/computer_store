...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-HDMI to DVI Cable</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/dvi.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">HDMI to DVI Cable</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">HDMI to DVI cable connects your monitor to diffirent type of ports. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 2,879.00</span></h4>
						<p class="vote" style="color: black;"><strong>93%</strong> of buyers enjoyed this item! <strong>(89 votes)</strong></p>
