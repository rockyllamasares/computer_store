...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-Microteck Digital Automatic Voltage Regulator</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/Microteck Digital avr.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">Microteck Digital Automatic Voltage  Regulator</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">87 reviews</span>
						</div>
						<p class="product-description" style="color: black;">Microteck Digital Automatic Voltage Regulator, if the currents runs unstable Microteck Digital AVR regulate its flow to avoid the damage into your computer. </p>
						<h4 class="price" style="color: black;">current price: <span>Php 6,587.00</span></h4>
						<p class="vote" style="color: black;"><strong>91%</strong> of buyers enjoyed this item! <strong>(89 votes)</strong></p>
