...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-System Unit Case</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/aero-300 case.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">AERO-300 System Unit Case</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;"89 reviews</span>
						</div>
						<p class="product-description" style="color: black;">AERO-300 System Unit Case to hold your other internal parts so strong that it could not move even the case turn upsidedown. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 4,873.00</span></h4>
						<p class="vote" style="color: black;"><strong>99%</strong> of buyers enjoyed this item! <strong>(122 votes)</strong></p>
