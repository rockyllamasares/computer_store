...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-MOLEX Adopter</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/molex pin adopter.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">MOLEX Adopter</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">Molex adopter with 4 pins connector, passage to provide electricity from power supply to motherboard. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 678.00</span></h4>
						<p class="vote" style="color: black;"><strong>91%</strong> of buyers enjoyed this item! <strong>(98 votes)</strong></p>
