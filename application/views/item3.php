...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-Memory Stick(RAM)</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/4gb ddr2.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">KIIisre DDR2 4GB RAM</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">This memory module or memory stick has a large capacity that can support your computer software by providing enough space for installation process and other processed data. </p>
						<h4 class="price" style="color: black;">current price: <span>Php 4,000.00</span></h4>
						<p class="vote" style="color: black;"><strong>98%</strong> of buyers enjoyed this item! <strong>(105 votes)</strong></p>
