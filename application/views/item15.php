...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-System Unit Fan</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/chasis fan.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">System Unit Cooling Fan</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">54 reviews</span>
						</div>
						<p class="product-description" style="color: black;">This fan pull out the high pressure inside your system unit by 100%, avoiding its parts from overheating. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 999.00</span></h4>
						<p class="vote"style="color: black;"><strong>91%</strong> of buyers enjoyed this item! <strong>(87 votes)</strong></p>
