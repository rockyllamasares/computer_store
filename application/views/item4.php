...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-Night Vision WebCam</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/6 led Night Vision Webcam.JPG'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">6 LED Night Vision WebCam</h3> 
						<div class="rating">
							<div class="stars" >
							...
							<span class="review-no" style="color: black;">76 reviews</span>
						</div>
						<p class="product-description" style="color: black;">6 LED Night Vision Camera has a clear sight pixel that can focus its lens at a 100% high quality view wether in day time or night time. Grab Now! </p>
						<h4 class="price" style="color: black;">current price: <span>Php 5,700.00</span></h4>
						<p class="vote" style="color: black;"><strong>99%</strong> of buyers enjoyed this item! <strong>(102 votes)</strong></p>
