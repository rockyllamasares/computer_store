				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/vga.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">Video Graphic Array Cable</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">VGA cable, display or extend your desktop screen with a high resolution. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 875.00</span></h4>
						<p class="vote" style="color: black;"><strong>95%</strong> of buyers enjoyed this item! <strong>(143 votes)</strong></p>
