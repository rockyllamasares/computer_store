				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/core i9.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">9th Generation Intel Core i9</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">298 reviews</span>
						</div>
						<p class="product-description" style="color: black;">The newest generation of intel processor having an incredible processing speed  with no respect to time. This is one of our hottest item deals. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 41,910.00</span></h4>
						<p class="vote" style="color: black;"><strong>100%</strong> of buyers enjoyed this item! <strong>(657 votes)</strong></p>
	
						<div class="action">
							<a href="<?php echo base_url('Login/checkout'); ?>" class="btn btn-warning">BUY NOW!</a>
							<a href="<?php echo base_url('Login/catalog'); ?>" class="btn btn-success">BACK</a>
