...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-Nektech Enternal HDD</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/Nektech 2.5-inch USBH Type externalhdd.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">USB Type Nektech External Hard Disk Drive</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">90 reviews</span>
						</div>
						<p class="product-description" style="color: black;">This external hard disk drive has the capacity to hold files, data or information over 1 terabyte file size. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 3,588.00</span></h4>
						<p class="vote" style="color: black;"><strong>98%</strong> of buyers enjoyed this item! <strong>(104 votes)</strong></p>
