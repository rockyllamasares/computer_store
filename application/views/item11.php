				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/PX1000 Lan Card.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">PX10000 LAN Card</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">105 reviews</span>
						</div>
						<p class="product-description" style="color: black;">PX10000 Lan Card has a high rate of speed in recieving signal and loading any files or website form the internet. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 2,987.00</span></h4>
						<p class="vote" style="color: black;"><strong>93%</strong> of buyers enjoyed this item! <strong>(79 votes)</strong></p>
	
						<div class="action">
							<a href="<?php echo site_url('Login/checkout'); ?>" class="btn btn-warning">BUY NOW!</a>
							<a href="<?pgp echo site_url('login/catalog'); ?>" class="btn btn-success">BACK</a>
