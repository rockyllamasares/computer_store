...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-B360M Intel Motherboard</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/Gigabyte B360M D3h Intel Motherboard.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">Gigabyte B360M D3h Intel Motherboard</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">B360M Intel Motherboard is hightech and more powerful motherboard, it has resistance if it was accidentally shake and fall into ground or any hard object.</p>
						<h4 class="price" style="color: black;">current price: <span>Php 5,080.00</span></h4>
						<p class="vote" style="color: black;"><strong>99%</strong> of buyers enjoyed this item! <strong>(234 votes)</strong></p>
