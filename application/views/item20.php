...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-Internal CD ROM</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/internal Cd ro.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">LG Internal CD ROM</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">56 reviews</span>
						</div>
						<p class="product-description" style="color: black;">LG Interanl CD ROM read cd disk in a high lazer reading system. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 2,788.00</span></h4>
