				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/sapphire pulse radeon RX Video Card $gb.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">Sapphire Pulse Radeon RX Video Card 4gb</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">78 reviews</span>
						</div>
						<p class="product-description" style="color: black;">Sapphire Video Card, good for gaming and it has a build in fan to avoid from overheating. </p>
						<h4 class="price" style="color: black;">current price: <span>Php 3,265.00</span></h4>
						<p class="vote" style="color: black;"><strong>97%</strong> of buyers enjoyed this item! <strong>(134 votes)</strong></p>
