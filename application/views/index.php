...
<body id="top">
      ...
      <header id="header" class="hoc clear">
        ...
        <nav id="mainav" class="fl_right"> 
          ...
          <ul class="clear">
            ...
            <li><a href="<?php echo site_url('Login/catalog'); ?>">Catalog</a></li>
  ...
  <div class="overlay">
    <div id="pageintro" class="hoc clear"> 
      ...
      <article>
        <h3 class="heading">Welcome To JTech Shop!</h3>
    ...
    <section id="introblocks">
      <ul class="nospace group btmspace-80">
        <li class="one_third first">
          <figure><a class="imgover" href="#"><img src="<?php echo base_url('assets/images/pic1.jpg'); ?>" alt=""></a>
            <figcaption>
              <h6 class="heading">POWERFUL SYSTEM UNIT</h6>
              <div>
                <p>Upgrading system to reach the limitless performance of the computer. </p>
              </div>
            </figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><a class="imgover" href="#"><img src="<?php echo base_url('assets/images/pic2.jpg'); ?>" alt=""></a>
            <figcaption>
              <h6 class="heading">ORGANIZE UNITS</h6>
              <div>
                <p>Good looking working area by organizing technology units.</p>
              </div>
            </figcaption>
          </figure>
        </li>
        <li class="one_third">
          <figure><a class="imgover" href="#"><img src="<?php echo base_url('assets/images/pic3.jpg'); ?>" alt=""></a>
            <figcaption>
              <h6 class="heading">MONEY</h6>
              <div>
                <p>Your money wont be waste in some nonsense material but in affordable and powerful equipment.</p>
              </div>
            </figcaption>
          </figure>
        </li>
