...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-Power Supply</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/ATX.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">ATX 600wh Power Supply</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">65 reviews</span>
						</div>
						<p class="product-description" style="color: black;">ATX Power Supply one of the leading and most used power supply in a system unit, provide enough voltage and it has a long term of service. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 2,500.00</span></h4>
						<p class="vote" style="color: black;"><strong>89%</strong> of buyers enjoyed this item! <strong>(90 votes)</strong></p>
