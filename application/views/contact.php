...
<div class="bgded" style="background-image:url('<?php echo base_url('assets/images/hapita.gif'); ?>');"> 
    ...
    <header id="header" class="hoc clear">
      ...
      <nav id="mainav" class="fl_right"> 
          ...
          <ul class="clear">
            ...
            <li class="active"><a href="<?php echo site_url('Login/contact'); ?>">Contact Us</a></li>
  ...
  <div class="overlay">
      <div id="pageintro" class="hoc clear"> 
        ...
        <article>
          <h3 class="heading">You Can Contact Us Using The Form Provided Below.</h3>
...
<div class="wrapper row3" style="background-image: url('<?php echo base_url('assets/images/blur.jpg'); ?>">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading"><h1 style="color: white; font-size: 30px;">Just fill up the form correctly and click submit.</h1></header>
