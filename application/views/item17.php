...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-External CD ROM</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/external CDROM.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">ALMAX External CD ROM</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">ALAMX External CD ROM reads diffirent kind of disk in a high speed loading system. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 3,234.00</span></h4>
