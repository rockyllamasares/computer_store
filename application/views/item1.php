...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-Internal WD Purple HDD</title>
        ...
        <style>
       body{
		   background-image: url("<?php echo base_url('assets/images/hapita.gif'); ?>");
		   height: 100vh;
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/1TB Western Purple HDD.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						<img src="<?php echo base_url('assets/images/600pixels/logos.png'); ?>" height="120px" width="240px">
						<h3 class="product-title" style="color: black;">WD Purple HDD (1 Terabyte)</h3> 
						<div class="rating">
							<div class="stars">
							...
							<span class="review-no" style="color: black;">41 reviews</span>
						</div>
						<p class="product-description" style="color: black;">This internal hard disk drive(HDD) has the capabilty to hold large amount of files or data. It has also a cooling system inside of it case and has a hard cover to secure the item once it is accidentally fall. </p>
						<h4 class="price" style="color: black;">current price: <span style="color: black;">Php 3,500.00</span></h4>
						<p class="vote" style="color: black;"><strong style="color: black;">91%</strong > of buyers enjoyed this item! <strong style="color: black;">(87 votes)</strong></p>
	
						<div class="action">
							<a href="<?php echo site_url('Login/checkout'); ?>" class="btn btn-warning">BUY NOW!</a>
							<a href="<?php echo site_url('Login/catalog'); ?>" class="btn btn-success">BACK</a>
