...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>JTech-Wireless Mouse</title>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/images/600pixels/wireless mouse.jpg'); ?>" /></div>
					...
					<div class="details col-md-6">
						...
						<h3 class="product-title" style="color: black;">Smooth Wireless Mouse</h3> 
						<div class="rating">
							<div class="stars">
						...
						<p class="product-description" style="color: black;">This wireless mouse was so smooth, easy to use and has a wide range of bluetooth connection. Grab it now!</p>
						<h4 class="price" style="color: black;">current price: <span>Php 1,3340.00</span></h4>
						<p class="vote" style="color: black;"><strong>96%</strong> of buyers enjoyed this item! <strong>(98 votes)</strong></p>
